...
## Open Model Artifacts from Dired {#open-model-artifacts-from-dired}
...
## Load MLIR and TableGen Modes from LLVM {#load-mlir-and-tablegen-modes-from-llvm}
...
## Use Block Indentation for C++ Tree-Sitter {#use-block-indentation-for-c-plus-plus-tree-sitter}
...
## Format Selected Lines with Clang-Format {#format-selected-lines-with-clang-format}
