...
#+DATE: 2026-03-05
#+ZOLA_ALIASES: /technical/project/emacs-02/
#+ZOLA_ALIASES: /blog/project/emacs-02/
#+ZOLA_CATEGORIES: systems-programming
#+ZOLA_TAGS: lisp-object memory-layout c-macros tagged-pointer
#+ZOLA_CUSTOM_FRONT_MATTER: :extra '((math . t) (math_auto_render . t))
#+ZOLA_SECTION: technical/emacs

@@md:![8 bytes many meanings](/images/8-bytes-many-meanings.png)@@

#+BEGIN_QUOTE
Source: [[https://x.com/chessMan786/status/1872641579615465924][Mohit Mishra]]
#+END_QUOTE
...
[[file:emacs-01.org][Emacs Internal #01: Emacs is a Lisp Runtime in C, Not an Editor]]
...
- [[https://en.wikipedia.org/wiki/Lisp_(programming_language)][Wiki - Lisp]] (LISt Processing)
- [[https://languagelog.ldc.upenn.edu/myl/llog/jmc.pdf][The Roots of Lisp]] - Paul Graham
...
Back to the GNU Emacs [[https://github.com/emacs-mirror/emacs][source code]], the core data type used to represent Elisp values in C is called ~Lisp_Object~, defined in ~src/lisp.h~.
...
According to the paper [[https://dl.acm.org/doi/epdf/10.1145/3386324][Evolution of Emacs Lisp]], early Emacs used 7-bit MSB (Most Significant Bit) tags. The modern LSB tagging scheme, which elegantly exploits the 8-byte alignment of heap allocations, was actually pioneered and implemented by Stefan Monnier during the development of Emacs 22 in 2007.
