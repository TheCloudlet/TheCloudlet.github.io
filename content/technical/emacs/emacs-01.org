...
#+DATE: 2026-02-26
#+ZOLA_ALIASES: /technical/project/emacs-01/
#+ZOLA_ALIASES: /blog/project/emacs-01/
#+ZOLA_CATEGORIES: systems-programming
#+ZOLA_TAGS: lisp-interpreter teco-macros mccarthy-axioms greenspun-tenth-rule
...
Joshua Blias's [[https://www.youtube.com/watch?v=sBc7toJaCxw][Returning to the Church (of Emacs)]] is a true story about switching to Neovim and coming back to GNU Emacs.

Here are common reasons why, in this modern world, people still use GNU Emacs, from a [[https://www.reddit.com/r/emacs/comments/1brnmds/why_use_emacs/][Reddit post]].
...
- Tsoding - [[https://www.youtube.com/watch?v=DMbrNhx2zWQ][The Annoying Usefulness of Emacs]]
...
In the 1970s, hackers at the MIT AI Lab used a text editor called [[https://en.wikipedia.org/wiki/TECO_(text_editor)][TECO]]. Unlike modern editors with a cursor, users had to input a sequence of password-like strings to cast the magic that edits text ([[https://github.com/blakemcbride/TECOC/blob/master/doc/teco-manual.txt][TECO manual]]). To reduce the pain, people started writing "macros" to speed up the process.

[[https://www.copters.com/pictures/teco_layout.gif][TECO keyboard layout]]

As macros grew larger and more complicated, they needed variables, ~if-else~ control flow, and loops. At that point, [[https://en.wikipedia.org/wiki/Richard_Stallman][Richard Stallman]] and [[https://en.wikipedia.org/wiki/Guy_L._Steele_Jr.][Guy Steele]] (the creator of Scheme) made a decision: "If the macro is complicated enough to act like a programming language, why not give it a real [[https://en.wikipedia.org/wiki/Turing_completeness][Turing-complete]] programming language?"
...
Later, Lisp machines were a commercial failure, and *C on von Neumann architecture* dominated the industry. When Richard Stallman and the [[https://en.wikipedia.org/wiki/Free_Software_Foundation][Free Software Foundation]] wanted a free Emacs on Unix, there was no Lisp environment there. At that time, [[https://en.wikipedia.org/wiki/James_Gosling][James Gosling]] wrote a *Lisp virtual machine and interpreter core in C*, called "Gosling Emacs". Richard Stallman took some of the code from Gosling Emacs and effectively reviving the spirit of Lisp machines in a Unix ecosystem, because it was the path of least resistance to a complete Unix toolchain.

This helps explain why GNU Emacs' source code looks the way it does, and why jokes like "a great operating system" evolved.

[[https://www.youtube.com/watch?v=IT__Nrr3PNI&t=3850s][James Gosling: Java, JVM, Emacs, and the Early Days of Computing | Lex Fridman Podcast]]
...
As to why C became dominant and not Lisp, a classic articulation of this "less elegant but more successful" outcome is Richard P. Gabriel's The Rise of [[https://www.dreamsongs.com/RiseOfWorseIsBetter.html][Worse is Better]]. Sometimes the real world works this way too...

** Greenspun's Tenth Rule

#+BEGIN_QUOTE
Any sufficiently complicated C or Fortran program contains an ad hoc, informally-specified, bug-ridden, slow implementation of half of Common Lisp.
-- [[https://philip.greenspun.com/research/][Philip Greenspun]]
#+END_QUOTE
...
| *union tagging* | tagged pointers + cons cells/immediates        | [[https://medium.com/@kannanvijayan/exboxing-bridging-the-divide-between-tag-boxing-and-nan-boxing-07e39840e0ca][NaN-tagging]] in LuaJIT |
...
This is also why my cache simulator [[https://github.com/TheCloudlet/Stratum][Stratum]] uses Racket to create a DSL for cache configuration.
...
- #03: [[file:emacs-03.org][Tagged Union, Tagged Pointer, and Poor Man's Inheritance]]
