...
[[https://herdr.dev][Herdr]] solves this as an agent-first multiplexer with a state sidebar, and
[[https://github.com/snirt/agenmux][agenmux]] ports its rules back into tmux. Both put the state in a surface of its
...
* The title carries nothing (for Claude)
...
* The foreground command names the wrong thing
...
taken from [[https://github.com/herdrdev/herdr/blob/master/src/detect/manifests/grok.toml][herdr's manifest]],
