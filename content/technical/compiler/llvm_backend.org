...
#+ZOLA_TAXONOMIES_TAGS: instruction-selection register-allocation instruction-scheduling risc-v
...
- *LLVM Documentation*: [[https://llvm.org/docs/CodeGenerator.html#instruction-selection][Instruction Selection]]
...
- *LLVM Documentation*: [[https://llvm.org/docs/MIRLangRef.html#scheduling][Machine Instruction Scheduler]]
...
- *LLVM Documentation*: [[https://llvm.org/docs/CodeGenerator.html#register-allocation][Register Allocation]]
...
- *RISC-V ABI Spec*: [[https://github.com/riscv-non-isa/riscv-elf-psabi-doc][RISC-V Calling Convention]]
...
- *LLVM Documentation*: [[https://llvm.org/docs/CodeGenerator.html#ssa-based-machine-code-optimizations][SSA-based Machine Code Optimizations]]
...
- [[https://llvm.org/docs/CodeGenerator.html][LLVM Code Generator]]
- [[https://llvm.org/docs/TableGen/index.html][TableGen Language Reference]]
- [[https://llvm.org/docs/WritingAnLLVMBackend.html][Writing an LLVM Backend]]
- [[https://llvm.org/docs/LangRef.html][LLVM Language Reference]]

** RISC-V Resources

- [[https://riscv.org/][RISC-V Foundation]]
- [[https://github.com/riscv][RISC-V Software Repository]]
- [[https://github.com/riscv-collab/riscv-gnu-toolchain][RISC-V Toolchain Documentation]]
