...
## Why Specialized Compiler Teams Matter {#why-specialized-compiler-teams-matter}
...
### The Compiler Engineer's Three Missions {#the-compiler-engineer-s-three-missions}
...
## RISC-V Architecture Fundamentals {#risc-v-architecture-fundamentals}
...
## LLVM Backend Pipeline {#llvm-backend-pipeline}
...
## STAGE 1: Instruction Selection {#stage-1-instruction-selection}
...
### DAG Tiling Theory {#dag-tiling-theory}
...
### TableGen Implementation {#tablegen-implementation}
...
## STAGE 2: Instruction Scheduling {#stage-2-instruction-scheduling}


### The Dual Mission {#the-dual-mission}
...
### Job 1: Hiding Latency {#job-1-hiding-latency}
...
### Job 2: Minimizing Register Pressure {#job-2-minimizing-register-pressure}
...
### Pre-RA vs Post-RA Scheduling {#pre-ra-vs-post-ra-scheduling}
...
## STAGE 3: SSA-based Machine Optimizations {#stage-3-ssa-based-machine-optimizations}
...
## STAGE 4: Register Allocation {#stage-4-register-allocation}
...
### The Spilling Disaster {#the-spilling-disaster}
...
### LLVM Register Allocators {#llvm-register-allocators}
...
## STAGE 5: Prolog/Epilog Insertion {#stage-5-prolog-epilog-insertion}
...
## STAGE 6: Post-RA Optimizations &amp; Phi Elimination {#stage-6-post-ra-optimizations-and-phi-elimination}
...
### Case A: Register Coalescing (Good Ending) {#case-a-register-coalescing--good-ending}
...
### Case B: Copy Insertion (Bad Ending) {#case-b-copy-insertion--bad-ending}
...
## STAGE 7: Code Emission {#stage-7-code-emission}
...
### perf: The Hardware Truth {#perf-the-hardware-truth}
...
### LLVM Debug Flags {#llvm-debug-flags}
...
## Practical Optimization Cases {#practical-optimization-cases}


### Case 1: Eliminating Spills in Loop {#case-1-eliminating-spills-in-loop}
...
### Case 2: Custom ISel Pattern {#case-2-custom-isel-pattern}
...
### Case 3: Loop Unrolling vs Register Pressure {#case-3-loop-unrolling-vs-register-pressure}
...
### Common RISC-V Instructions {#common-risc-v-instructions}
...
### LLVM Core Documentation {#llvm-core-documentation}
