...
## Memory Systems Interview Prep {#memory-systems-interview-prep}

Based on CSAPP Chapter 6: The Memory Hierarchy


## Week 1 Day 1-2: Memory Hierarchy {#week-1-day-1-2-memory-hierarchy}
...
## Week 1 Day 3-4: Cache Basics {#week-1-day-3-4-cache-basics}
...
1.  What is loop blocking (tiling)? Why does it improve cache performance?


## Week 1 Day 5-6: Virtual Memory Part 1 {#week-1-day-5-6-virtual-memory-part-1}
...
## Week 1 Day 7: Virtual Memory Part 2 + TLB {#week-1-day-7-virtual-memory-part-2-plus-tlb}
