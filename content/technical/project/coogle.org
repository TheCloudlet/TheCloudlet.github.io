...
#+DATE: 2025-12-02
#+ZOLA_ALIASES: /blog/project/coogle/
#+ZOLA_TAXONOMIES_CATEGORIES: software-tooling
#+ZOLA_TAXONOMIES_TAGS: ast-parsing libclang string-interning type-canonicalization
#+ZOLA_SECTION: technical/project

* Why I Started This Project?

The story started in 2024, when I decided to review basic algorithms and data structures. I started a repository called "[[https://github.com/TheCloudlet/LeetcodeHero][From Zero to Leetcode Hero]]." My intention was to learn and solve LeetCode problems using C++ and Haskell together.
...
While exploring Haskell, I found an incredibly useful tool called [[https://hoogle.haskell.org/][Hoogle]], which allows you to search for functions by their type signatures.
...
Stay tuned for: /"Inside libclang: From Visitor Pattern to AST Mastery"/
...
[[file:../cpp/cpp_string.org][Back to Basics: From C char to string_view (Notes from building Coogle)]]
...
If you're interested in trying Coogle, check out the repository: [[https://github.com/TheCloudlet/Coogle][github.com/TheCloudlet/Coogle]]
