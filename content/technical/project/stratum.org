...
#+ZOLA_CATEGORIES: computer-architecture
#+ZOLA_TAGS: cache-hierarchy template-metaprogramming cache-simulator
...
@@md:![Stratum memory hierarchy diagram](/images/stratum-svg.svg)@@
