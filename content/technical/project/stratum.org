...
#+DATE: 2026-01-29
#+ZOLA_ALIASES: /blog/project/stratum/
#+ZOLA_TAXONOMIES_CATEGORIES: computer-architecture
#+ZOLA_TAXONOMIES_TAGS: cache-hierarchy template-metaprogramming cache-simulator
#+ZOLA_SECTION: technical/project

* The Interview That Changed Everything

During a recent interview, the conversation started well. The interviewer asked about my open-source contribution to [[https://github.com/sysprog21/rv32emu][rv32emu]]—specifically, how I achieved 52% faster lookups and 35% faster insertions in the red-black tree implementation ([[https://github.com/sysprog21/rv32emu/commit/434c46660f67c78d9a4f587e05d2d59ec2102dc0][commit 434c466]]).
...
That's when I realized: I could optimize /for/ cache behavior, but I didn't actually understand /how/ caches work.
...
After that interview, I needed to understand caches from first principles. I started with CS:APP Chapter 6 ([[https://www.cs.sfu.ca/~ashriram/Courses/CS295/assets/books/CSAPP_2016.pdf][book]], [[https://www.youtube.com/watch?v=vusQa4pfTFU][lectures]])—the canonical resource for cache architecture.
...
- [[https://www.cs.sfu.ca/~ashriram/Courses/CS295/assets/books/CSAPP_2016.pdf][CS:APP Chapter 6]] - Cache fundamentals
- [[https://web.mit.edu/6.001/6.037/sicp.pdf][SICP Chapter 1.2]] - Recursive processes
- [[https://people.freebsd.org/~lstewart/articles/cpumemory.pdf][What Every Programmer Should Know About Memory]] - Section 3.1
...
[[/images/stratum-svg.svg][Stratum memory hierarchy diagram]]
...
/(Apologies to Canadian aviation students Not up--we're compiler people, we dig)/

From a compiler backend perspective, every load instruction digs /down/ through memory layers to find data. Which stratum is your data in? L1? L2? DRAM? The depth determines the latency.
...
After studying CS:APP and building [[https://github.com/TheCloudlet/Stratum][Stratum]], I can now properly answer those interview questions. More importantly, I understand /why/ my rb-tree optimization worked--and when it might not.
...
1. Compare the address tag against /all ways/ in the set (parallel)
...
Visit [[https://github.com/TheCloudlet/Stratum][Stratum README]] for instructions on:
...
- GitHub: [[https://github.com/TheCloudlet/Stratum][TheCloudlet/Stratum]]
