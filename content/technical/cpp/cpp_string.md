...
## PART 1: C99 chars and strings {#part-1-c99-chars-and-strings}
...
### Quick C99 Char Summary {#quick-c99-char-summary}
...
### C Strings philosophy recap {#c-strings-philosophy-recap}
...
## PART 2: std::string and the Template Monster {#part-2-std-string-and-the-template-monster}
...
### The Typedef Illusion {#the-typedef-illusion}
...
### class basic_string {#class-basic-string}
...
## PART 3: The Cost of Abstraction (SSO, Linux, and string_view) {#part-3-the-cost-of-abstraction--sso-linux-and-string-view}
...
### The Missing Piece: std::string_view (C++17) {#the-missing-piece-std-string-view--c-plus-plus-17}
...
## Conclusion: The "Swiss Army Knife" vs. The Scalpel {#conclusion-the-swiss-army-knife-vs-dot-the-scalpel}
