...
#+DATE: 2025-11-20
#+ZOLA_ALIASES: /blog/cpp/cpp_string/
#+ZOLA_ALIASES: /blog/cpp/cpp-string/
#+ZOLA_TAXONOMIES_CATEGORIES: systems-programming
#+ZOLA_TAXONOMIES_TAGS: std-string-view pmr-allocator small-string-optimization
#+ZOLA_SECTION: technical/cpp

* Background

When I was implementing [[https://github.com/TheCloudlet/Coogle][Coogle]], I discovered something bizarre about C++ strings. That is why I wrote this note to summarize what I learned about C++ strings.
...
As Jserv always says in [[https://hackmd.io/@sysprog/c-programming][C Programming series]]:
...
- [[https://retrocomputing.stackexchange.com/questions/24855/null-terminated-strings-on-the-pdp-7][Null-terminated strings on the PDP-7 (retrocomputing.stackexchange)]]
- [[https://www.reddit.com/r/cpp_questions/comments/qlzho1/why_did_c_and_linux_api_use_nullterminated_strings/][Why did C and Linux API use null-terminated strings? (reddit r/cpp_questions)]]
- [[https://stackoverflow.com/questions/2221304/why-do-strings-in-c-need-to-be-null-terminated][Why do strings in C need to be null terminated? (stack overflow)]]
#+END_QUOTE
...
Reference: [[https://people.freebsd.org/~lstewart/articles/cpumemory.pdf][Paper: What Every Programmer Should Know About Memory]]
...
- *Traits*:
  ...
  - Hmm... is more interesting. Accoding to [[https://en.cppreference.com/w/cpp/string/char_traits][cppreference:char_traits]]:
...
(Numbers from [[https://www.agner.org/optimize/][agner.org]])
